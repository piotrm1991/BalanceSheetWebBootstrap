					...
					<div class="row">
						<div class="col-sm-6">
							<form action="cancel.php">
								<button class="btn btn-default btn-sm btn-block" name="addIncomeButton" id="addIncomeButton" >Anuluj</button>
							</form>
						</div>
						<div class="col-sm-6">
							<form action="save.php">
								<button class="btn btn-default btn-sm btn-block" name="addIncomeButton" id="addIncomeButton" >Zapisz</button>
							</form>
						</div>
					</div>
				</section>
